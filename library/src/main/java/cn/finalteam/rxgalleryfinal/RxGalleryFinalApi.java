...
public class RxGalleryFinalApi {
     ...
     */
    public static RxGalleryFinalApi getInstance(@NonNull Activity context) {
     ...
     * 单选默认设置
     */
    public RxGalleryFinalApi openGalleryRadioImgDefault(RxBusResultDisposable<ImageRadioResultEvent> rxBusResultDisposable, int selectedByDefault, AspectRatio... aspectRatio) {
        Logger.i("----rxGalleryFinal---" + rxGalleryFinal);
        rxGalleryFinal
                .image()
                .radio()
                .crop()
                .cropAspectRatioOptions(selectedByDefault, aspectRatio)
                .cropAllowedGestures(UCropActivity.SCALE, UCropActivity.SCALE, UCropActivity.SCALE)
                .imageLoader(ImageLoaderType.GLIDE)
                .subscribe(rxBusResultDisposable)
                .openGallery();
        return mRxApi;
...
//                cameraActivity.grantUriPermission()
